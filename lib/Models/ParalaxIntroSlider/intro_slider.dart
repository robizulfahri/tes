...
import 'package:neotelemetri_or11/Models/ParalaxIntroSlider/list_rtl_language.dart';
...
class IntroSlider extends StatefulWidget {
  ...
  /// Color for NEXT button
  final Color colorNextBtn;

  /// Color for NEXT button when press
  final Color highlightColorNextBtn;
  ...
  // ---------- Dot indicator ----------
  /// Render your own DOT button
  final Widget renderDotBtn;
  ...
  IntroSliderState createState() {
    return new IntroSliderState(
      ...
      // Next
      colorNextBtn: this.colorNextBtn,
      highlightColorNextBtn: this.highlightColorNextBtn,
      borderRadiusNextBtn: this.borderRadiusNextBtn,
      renderNextBtn: this.renderNextBtn,
      nameNextBtn: this.nameNextBtn,

      // Dots
      renderDotBtn: this.renderDotBtn,
...
class IntroSliderState extends State<IntroSlider>
  ...
  IntroSliderState({
    ...
    @required this.colorNextBtn,
    @required this.highlightColorNextBtn,
    @required this.borderRadiusNextBtn,

    // Dot indicator
    @required this.renderDotBtn,
  ...
  void setupButtonDefaultValues() {
    ...
    // Prev button
    if (isShowSkipBtn == null || isShowPrevBtn) {
      isShowSkipBtn = false;
    }
    ...
    if (colorNextBtn == null) {
      colorNextBtn = defaultBtnColor;
    }
    if (highlightColorNextBtn == null) {
      highlightColorNextBtn = defaultBtnHighlightColor;
    }
    if (borderRadiusNextBtn == null) {
      borderRadiusNextBtn = defaultBtnBorderRadius;
    }
  ...
  Widget buildNextButton() {
    return RaisedButton(
      ...
      child: renderNextBtn,
      color: colorNextBtn,
      highlightColor: highlightColorNextBtn,
      shape: new RoundedRectangleBorder(
          borderRadius: new BorderRadius.circular(borderRadiusNextBtn)),
    );
  }
      ...
      child: Row(
        children: <Widget>[
          ...
          Container(
            ...
            child: isShowPrevBtn
                ? buildPrevButton()
                : (isShowSkipBtn ? buildSkipButton() : Container()),
            width: isShowPrevBtn
